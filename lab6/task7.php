...
{ 
 ...
 $this->_data['message']=$text; echo $this->_data['message'].PHP_EOL; 
...
echo "I sent a tweet"; 
    ...
    interface NotificationInterface {   public function setData($data);   public function sendNotification(); 

} 

class TwitterAdapter implements NotificationInterface 

{   protected $_data;   public function setData($data){ 
...
class NotificationManager implements INotificationManager { 
  ...
  {     switch($type){       case "twitter": 

        $notification = new TwitterAdapter(); 

        break;       case "sms": 

        $notification = new SmsAdapter();         break;         default: 

      echo "еrror";         return false;         break; 
